...
class CircleView: UIView {
    ...
    /*func detectTouch(center:CGPoint, radius:Float, r:Float){
    
      var myRect=CGRectMake(center.x-radius, cemter.y-radius, 2r, 2r)
        //and detect touch inside that rect by picking touch point as
    
        var touch:CGPoint =[[touches anyObject]locationInView:self];
